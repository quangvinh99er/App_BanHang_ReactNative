...
import { Platform, DeviceEventEmitter, NativeModules, NativeEventEmitter, Text, View, Button } from 'react-native';
...
const Payment = (props) => {
    ...
    return(
        <View>
            <Button onPress={onPress} title="Payment" />
        </View>
    )
}
